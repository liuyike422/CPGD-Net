from typing import Mapping, Any, Tuple, Callable, Dict, Literal, Optional
import importlib
import os
...
def make_tiled_fn(
    ...
    scale: int = 1,
    channel: Optional[int] = None, #int | None = None,
    weight: Literal["uniform", "gaussian"] = "gaussian",
    dtype: Optional[torch.dtype] = None, #torch.dtype | None = None,
    device: Optional[torch.device] = None, #torch.device | None = None,
